...
export const TimeLineData = [
  ...
  { year: 2021, text: 'Learnt Javascript, Node.JS' },
  { year: 2022, text: 'Joined a tech Institute, Learnt software development/engineering' },
  { year: 2023, text: 'Built 3+ projects (some are still in progress)' },
];